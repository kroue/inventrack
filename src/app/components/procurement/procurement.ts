      ...
      <html>
        <head>
          ...
          <style>
            ...
            .header h1 { margin: 0; color: #111; font-size: 24px; letter-spacing: 1px; }
            .header p { margin: 5px 0; color: #666; font-size: 14px; text-transform: uppercase; }
            .details { display: flex; justify-content: space-between; margin-bottom: 30px; font-size: 14px; background: #f9f9f9; padding: 20px; border-radius: 8px; }
            .details-col p { margin: 5px 0; }
            table { width: 100%; border-collapse: collapse; margin-bottom: 30px; }
            th, td { border-bottom: 1px solid #ddd; padding: 12px; text-align: left; }
            th { background-color: #f1f5f9; font-weight: 600; color: #333; text-transform: uppercase; font-size: 12px; }
            .total { text-align: right; font-size: 18px; font-weight: bold; background: #f1f5f9; padding: 15px; border-radius: 8px; }
        ...
        <body>
          ...
          <div class="footer">
            Generated by InvenTrack System on ${new Date().toLocaleDateString()}<br>
